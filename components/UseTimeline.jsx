  ...
  return (
    <section className="w-screen overflow-hidden pb-24">
      <div className="container mx-auto border-t border-b border-dashed">
        <div className="relative flex w-full max-w-5xl flex-col items-center justify-center border border-t-0 border-b-0 border-dashed px-5 py-12 md:px-10 lg:mx-auto lg:px-15">
              ...
              {items.map((item) => (
                ...
                >
                  <TimelineHeader>
                    ...
                    <TimelineDate className="mt-2 mb-2 font-medium uppercase underline underline-offset-2">
                      {item.date}
                    </TimelineDate>
                    <TimelineTitle className="mt-0.5 text-base">
                      {item.title}
                    </TimelineTitle>
                    <TimelineIndicator className="bg-primary/10 group-data-completed/timeline-item:bg-primary group-data-completed/timeline-item:text-primary-foreground flex size-9 items-center justify-center border-none group-data-[orientation=vertical]/timeline:-left-7">
                      <item.icon size={16} />
                    </TimelineIndicator>
                  </TimelineHeader>
