  ...
  return (
    <section className="h-full w-screen overflow-hidden py-24">
      <div className="container mx-auto border-t border-b border-dashed">
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center border border-t-0 border-b-0 border-dashed py-20">
        ...
        <ul className="mx-auto grid h-44 w-full max-w-7xl grid-cols-1 border border-b-0 border-dashed md:h-34 md:grid-cols-2 lg:h-24 lg:grid-cols-3">
